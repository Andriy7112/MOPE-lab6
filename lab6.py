...
for g in range(100):
    ...
    Y1 = [round(2.9 + 3.9*X1[i] + 6.7*X2[i] + 4.4*X3[i] + 9.7*X1kv[i] + 0.8*X2kv[i] + 7.5*X3kv[i]+ 1.0*X12[i] + 1.0*X13[i] + 0.8*X23[i] + 4.2*X123[i] + random.randrange(-10 ,10)-5 ,3) for i in range(15)]
    Y2 = [round(2.9 + 3.9*X1[i] + 6.7*X2[i] + 4.4*X3[i] + 9.7*X1kv[i] + 0.8*X2kv[i] + 7.5*X3kv[i]+ 1.0*X12[i] + 1.0*X13[i] + 0.8*X23[i] + 4.2*X123[i] + random.randrange(-10 ,10)-5 ,3) for i in range(15)]
    Y3 = [round(2.9 + 3.9*X1[i] + 6.7*X2[i] + 4.4*X3[i] + 9.7*X1kv[i] + 0.8*X2kv[i] + 7.5*X3kv[i]+ 1.0*X12[i] + 1.0*X13[i] + 0.8*X23[i] + 4.2*X123[i] + random.randrange(-10 ,10)-5 ,3) for i in range(15)]
...
# Завдання:Запустити 100 разів знайти середнє значення усіх не значимих коефіцієнтів
try:
    result = sum(for_task) / len(for_task)
except ZeroDivisionError:
    result = 0

print(f"Середнє значення усіх не значимих коефіцієнтів за 100 разів: {result}")
